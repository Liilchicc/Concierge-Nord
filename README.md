...
```
.
├── assets/                  # Placeholders (hero, galerie, plan, contact) + logo doré intégré
...
- Le logo fourni est `assets/logo-gold.svg` (déjà utilisé dans la page). Remplacez-le par votre version si besoin en gardant le même nom.
